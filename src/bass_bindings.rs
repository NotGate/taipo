...
fn bindgen_test_layout_BASS_BFX_COMPRESSOR() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<BASS_BFX_COMPRESSOR>())).fReleasetime as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
pub type BPMPROC = ::std::option::Option<
    unsafe extern "C" fn(chan: DWORD, bpm: f32, user: *mut ::std::os::raw::c_void),
>;
pub type BPMPROGRESSPROC = ::std::option::Option<
    unsafe extern "C" fn(chan: DWORD, percent: f32, user: *mut ::std::os::raw::c_void),
>;
...
pub type BPMBEATPROC = ::std::option::Option<
    unsafe extern "C" fn(chan: DWORD, beatpos: f64, user: *mut ::std::os::raw::c_void),
>;
extern "C" {
    pub fn BASS_FX_BPM_BeatCallbackSet(
        handle: DWORD,
        proc_: BPMBEATPROC,
        user: *mut ::std::os::raw::c_void,
    ) -> BOOL;
...
extern "C" {
    pub fn BASS_FX_BPM_BeatSetParameters(
        handle: DWORD,
        bandwidth: f32,
        centerfreq: f32,
        beat_rtime: f32,
